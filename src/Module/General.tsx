...
const goldSponsor = [{src: "https://s3.ap-south-1.amazonaws.com/innohacks3.0/Untitled-BUcWHqrv.png",alt:"ETHINDIA LOGO"},, {src: "https://s3.ap-south-1.amazonaws.com/innohacks3.0/polygon-removebg-preview.png",alt:"POLYGON LOGOn"}];
